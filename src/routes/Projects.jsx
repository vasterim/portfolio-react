  ...
  return (
    <div className='row flex w-full justify-center flex-col items-center'>
      ...
      <ul className="flex justify-evenly flex-wrap">
              {
                projects.map((project, key) => <div key={key} className='bg-black max-lg:min-w-32 min-h-[500px] rounded-lg p-10 text-center h-max border border-white border-opacity-0 mx-16 my-16 flex flex-col justify-start items-center min-w-96'>
